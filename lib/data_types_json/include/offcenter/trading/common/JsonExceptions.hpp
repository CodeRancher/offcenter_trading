...
/// Invalid Json Conversion Exception
class InvalidJsonConversionException: public TradingRuntimeException
{
public:
	explicit InvalidJsonConversionException(const std::string& what_arg): TradingRuntimeException(what_arg) {}
	explicit InvalidJsonConversionException(const char* what_arg): TradingRuntimeException(what_arg) {}
};
