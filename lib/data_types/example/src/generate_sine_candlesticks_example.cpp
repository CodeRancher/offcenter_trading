...
/**
 * @file   generate_sine_candlesticks_example.cpp
 * @author Scott Brauer
 * @date   12-03-2021
 */
...
int main(int argc, char **argv)
{
	...
	imgui_main<GenerateSineCandlesticksExampleApp>(argc, argv, "Generate Sine Candlesticks Example", "GenerateSineCandlesticksExampleApp");
}
