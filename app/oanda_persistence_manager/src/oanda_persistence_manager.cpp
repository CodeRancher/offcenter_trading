...
/**
 * @file   oanda_persistence_manager.hpp
 * @author Scott Brauer
 * @date   05-18-2021
 */
...
int main(int argc, char **argv)
{
	try {
		...
		std::cout << "Rest Server Example App!" << std::endl;

		el::Loggers::reconfigureAllLoggers(el::ConfigurationType::ToFile, "true");
		el::Loggers::reconfigureAllLoggers(el::ConfigurationType::ToStandardOutput, "false");
		el::Loggers::reconfigureAllLoggers(el::ConfigurationType::Format, "%datetime:%thread [%level] %msg");
		el::Loggers::reconfigureAllLoggers(el::ConfigurationType::Filename, "./OandaPersistenceManager.log");
