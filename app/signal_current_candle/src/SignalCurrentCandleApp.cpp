...
void SignalCurrentCandleApp::onInitAMQP(offcenter::common::amqp::ConnectionURIOptions& options)
{
	options = *m_amqpServerOptions;
}

void SignalCurrentCandleApp::onInitAMQPSessions(offcenter::common::amqp::ConnectionPtr connection)
{
	// Create a Session
